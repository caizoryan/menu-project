export let JARS = {
	...
	},
	{
		...
		description: "fresh strawberries, blueberries, baby spinach, crunchy walnuts, and a drizzle of balsamic-honey dressing."
	},
	...
	items: [
		{
			...
			description: "tofu , spicy schezwan hollandaise, spring onion garnish."
		},
		{
			title: "Branston & Cheddar Benedict",
			description: "Branston pickle, cheddar slice, brown butter hollandaise."
		},
		{
			title: "Smoked Salmon",
			description: "Smoked Salmon with arugula, cream cheese & hollandaise"
		},
		{
			title: "Florentine Benedict",
			description: "Spinach sautéed with garlic butter, poached eggs, chicken salami, parmesan, hollandaise."
		},
	]
}
...
export let EGGS = {
	...
	items: [
		...
		},
		{
			...
			description: "Classic combination of smoky ham and cheese."
		},
		...
		{
			title: "Spicy Masala cheese Scramble",
			description: ""
		},

		{
			title: "Poached Eggs 2pc",
			description: ""
		},
		{
			title: "Soft-Boiled Eggs 2pc",
			description: ""
		}
	]
}
